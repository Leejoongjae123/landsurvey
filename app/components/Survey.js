...
function Survey({ selectedLanguage, agencyEmail }) {
  ...
  const handleSend = async () => {
    ...
    let data = {
      ...
      answer3: answer3,
      answer4: answer4,
      answer5: answer5.join(" ~ "),
      answer6: answer6.join(" ~ "),
      answer7: answer7.join(" / "),
      answer8: answer8.join(" / "),
      answer9: answer9.join(" / "),
      answer10: answer10.join(" / "),
      answer11: answer11.join(" ~ "),
      answer12: answer12.join(" ~ "),
      answer13: answer13.join(" ~ "),
      answer14: answer14.join(" / "),
      answer15: answer15.join(" / "),
      answer16: answer16.join(" / "),
      answer17: answer17.join(" ~ "),
      answer18: answer18.join(" ~ "),
          ...
          <div className="space-y-8 flex flex-col justify-center items-center">
            ...
            <div className="flex w-full flex-col">
              <Tabs
                ...
                color="primary"
              >
                <Tab key="Monthly rent" title="Monthly rent">
                  <Card>
                    <CardBody className="gap-8 p-[1.5rem]">
                      <div className="flex flex-col w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <div className="flex flex-col w-full gap-4">
                          <DatePicker
                            ...
                            onChange={(e) => {
                              setAnswer1([`${e.year}년${e.month}월${e.day}일`, ...answer1.slice(1)]);
                            }}
                          />
                          <DatePicker
                            label="To"
                            className="w-2/3 md:w-1/3"
                            onChange={(e) => {
                              setAnswer1([answer1[0], `${e.year}년${e.month}월${e.day}일`]);
                            }}
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <div className="flex w-full ">
                          <RadioGroup onChange={handleChange3}>
                            <Radio value="학생">
                              {questions?.answer3?.answer1}
                            </Radio>
                            <Radio value="직장인">
                              {questions?.answer3?.answer2}
                            </Radio>
                            <Radio value="사업자">
                      ...
                      <div className="flex flex-col w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            setAnswer5((prev) => [value, ...prev.slice(1)]);
                          }}
                          startContent={
                      ...
                      <div className="flex flex-col w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            const value = e.target.value;
                            setAnswer6((prev) => [value, ...prev.slice(1)]);
                          }}
                          startContent={
                            <div className="pointer-events-none flex items-center">
                              <span className="text-default-400 text-small">
                    ...
                    <CardBody className="gap-8 p-[1.5rem]">
                      <div className="flex flex-col w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <div className="flex w-full flex-col gap-4 ">
                          <DatePicker
                            ...
                            className="w-2/3 md:w-1/3"
                            onChange={(e) => {
                              setAnswer11([`${e.year}년${e.month}월${e.day}일`, ...answer11.slice(1)]);
                            }}
                          />
                          <DatePicker
                            label="To"
                            className="w-2/3 md:w-1/3"
                            onChange={(e) => {
                              setAnswer11([answer11[0], `${e.year}년${e.month}월${e.day}일`]);
                            }}
                          />
                        </div>
                      </div>
                      <div className="flex flex-col w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <div className="flex flex-col w-full gap-4">
                          <DatePicker
                            ...
                            className="w-2/3 md:w-1/3"
                            onChange={(e) => {
                              setAnswer12([`${e.year}년${e.month}월${e.day}일`, ...answer12.slice(1)]);
                            }}
                          />
                          <DatePicker
                            label="To"
                            className="w-2/3 md:w-1/3"
                            onChange={(e) => {
                              setAnswer12([answer12[0], `${e.year}년${e.month}월${e.day}일`]);
                            }}
                          />
                        </div>
                      </div>
                      <div className="flex flex-col w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            const value = e.target.value;
                            setAnswer13((prev) => [value, ...prev.slice(1)]);
                          }}
                          startContent={
                            <div className="pointer-events-none flex items-center">
                              <span className="text-default-400 text-small">
                    ...
                    <CardBody className="gap-8 p-[1.5rem]">
                      <div className="flex flex-col w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <div className="flex w-full flex-col gap-4 ">
                          <DatePicker
                            ...
                            className="w-2/3 md:w-1/3"
                            onChange={(e) => {
                              setAnswer17((prev) => [`${e.year}년${e.month}월${e.day}일`, ...prev.slice(1)]);
                            }}
                          />
                          <DatePicker
                            label="To"
                            className="w-2/3 md:w-1/3"
                            onChange={(e) => {
                              setAnswer17((prev) => [prev[0], `${e.year}년${e.month}월${e.day}일`]);
                            }}
                          />
                        </div>
                      </div>
                      <div className="flex flex-col w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            const value = e.target.value;
                            setAnswer18((prev) => [value, ...prev.slice(1)]);
                          }}
                          startContent={
                            <div className="pointer-events-none flex items-center">
                              <span className="text-default-400 text-small">
